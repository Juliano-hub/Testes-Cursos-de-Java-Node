...
app.get("/", function(req, res){
    // com o .sendFile ele manda um arquivo HTML na entrada em vez das mensagens anteriores
    res.sendFile(__dirname + "/ArquivoHTML/index.html");
    // o __dirname ele pega o endereço onde se encontra este arquivo, depois do '+' é para localizar o arquivo HTML que vai ser mandado
});

app.get("/sobre",function(req, res){
    // com o .sendFile ele manda um arquivo HTML na entrada em vez das mensagens anteriores
    res.sendFile(__dirname + "/ArquivoHTML/sobre.html");
    // o __dirname ele pega o endereço onde se encontra este arquivo, depois do '+' é para localizar o arquivo HTML que vai ser mandado
});
